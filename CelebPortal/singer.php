...
<html lang="en" dir="ltr">
    <head>
        ...
        <div class="pagetitle">
                    <h1><span class="fas fa-music"></span> Singer</h1>
            </div>
            <div class="container">
            <div class="filtercontainer">
                ...
                <div class="row">
                        ...
                        $getyoutuber = "SELECT * FROM wholeceleb WHERE tag='Singer' LIMIT $start_from,$num_per_page";
                ...
                <div class="paging"> 
                    <label >Page: </label>
                    <?php
                        $pr_query = "SELECT * FROM wholeceleb WHERE tag='Singer'";
                        ...
                        for($i=1;$i<$total_page;$i++){
                            echo "<a href='singer.php?page=".$i."'class='number'>$i</a>";
                        }
                    ?>
                </div>
