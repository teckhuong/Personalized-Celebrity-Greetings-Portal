            ...
            <form action="" method="POST">
                ...
                <label class="occassion" for="occassion">Occassion: </label>
                    ...
                    <option value="Others">Others</option>
                        ...
                        <input type="hidden" value="<?php $username ?>" />
                <label><strong>Instruction: </strong>
		            <textarea name="instruct" id="instruct" rows="3" cols="70" placeholder="Enter your instruction here."></textarea>
	            </label><br/>
                ...
                <input type="submit" name="personalorder" />
            </form>
        </section>
             <!-- footer -->
